...
var MATCH = exports.MATCH = 1;
var EXACT_MATCH = exports.EXACT_MATCH = 2;
var NOT_MATCH = exports.NOT_MATCH = 0;
var URL_CHANGE = exports.URL_CHANGE = '@@router/URL_CHANGE';
var URL_CHANGE_BLOCK = exports.URL_CHANGE_BLOCK = '@@router/URL_CHANGE_BLOCK';
var URL_CHANGE_UNBLOCK = exports.URL_CHANGE_UNBLOCK = '@@router/URL_CHANGE_UNBLOCK';
...
var _simpleNormalizr = __webpack_require__(33);
...
var _selectn = __webpack_require__(83);
...
function simple(entity, obj, schema) {
  ...
  entity[obj[schema.id]] = schema.entityAssignment(obj);
  return {
    result: id
  };
}
function array(entity, objs, schema) {
  if (Array.isArray(objs)) {
    var ids = objs.map(function (obj) {
      var id = obj[schema.id];
      entity[id] = schema.entityAssignment(obj);
      return id;
    });
    return {
      result: ids
    ...
    var ids = Object.keys(objs).reduce(function (res, objKey) {
      var id = objKey;
      entity[id] = schema.entityAssignment(objs[objKey]);
      res[id] = id;
      return res;
    }, {});
    return {
...
function schema(entityName) {
  ...
  var mapping = _ref$mapping === undefined ? null : _ref$mapping;
  var _ref$id = _ref.id;
  var id = _ref$id === undefined ? 'id' : _ref$id;
  var _ref$group = _ref.group;
  var group = _ref$group === undefined ? "object" : _ref$group;
  var _ref$entityAssignment = _ref.entityAssignment;
  var entityAssignment = _ref$entityAssignment === undefined ? null : _ref$entityAssignment;
...
function arrayOf(ob) {
  return Object.assign(ob, { group: "array" });
}
...
var Link = exports.Link = function (_React$Component) {
  ...
  _createClass(Link, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('a', { href: href, onClick: this.onClick, className: isActive ? "active" : "" }, children);
    }
  }]);
...
var bind = Function.prototype.bind || __webpack_require__(42)
...
var _storeShape = __webpack_require__(25);
...
var curry2 = __webpack_require__(38)
var debug = __webpack_require__(39)('selectn')
var dotted = __webpack_require__(37)
var splits = __webpack_require__(41)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18), __webpack_require__(87)(module)))
